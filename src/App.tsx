  ...
  return (
    <Center>
      <Limit>
        ...
        <Title>
          Aprenda a <Yellow>concentrar-se</Yellow> melhor e alcance seus{" "}
          <Yellow>objetivos</Yellow> com nosso e-book de melhoria do{" "}
          <Yellow>foco</Yellow>
        </Title>
        <Subtitle>
          <Underline>
            Você já se sentiu sobrecarregado com as demandas constantes da vida
            moderna?
          </Underline>{" "}
          <Yellow>
            Deseja encontrar uma maneira de se concentrar nas tarefas
            importantes e alcançar seus objetivos com mais facilidade?
          </Yellow>{" "}
          Se sim, nosso e-book sobre como ter foco é perfeito para você.{" "}
          <Yellow>
            Aprenda as habilidades essenciais para superar distrações, melhorar
            sua produtividade e desbloquear todo o seu potencial.
          </Yellow>
        </Subtitle>
        ...
        >
          <ButtonContainer>
            <Button>
              <ButtonText>COMPRAR E-BOOK AGORA</ButtonText>
            </Button>
          </ButtonContainer>
        </ButtonHotmart>
        <SafeBuy src={safeBuy} />
          ...
          {asks.map((item, index) => (
            <AccordionContainer>
              <AccordionHeader
                onClick={() => {
                  setOpened(
                    opened === String(index + 1) ? "" : String(index + 1)
                  );
                }}
              >
      ...
      <Footer>
        <FooterLimit>
          ...
          <FooterText>
            Para garantir que as estratégias tragam resultados, é necessário
            aplicar todos os ensinamentos conforme o recomendado. Os resultados
            podem variar e dependem unicamente de cada pessoa em colocar em
            prática as estratégias aprendidas. Lembre-se que cada um tem sua
            individualidade, experiência e rotinas, não compare seu resultado
            com o de outros e siga dando o seu melhor todos os dias. A chave
            para ter resultados e sucesso é a consistência.
          </FooterText>

          <FooterText>
            Todos os direitos reservados para: Melhor você focar – 2023
          </FooterText>
        </FooterLimit>
      </Footer>
    </Center>
